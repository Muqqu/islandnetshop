...
class AddOnResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        {
            $addons['data'] = [
                'title' => settingHelper('refund_protection_title',$lang),
                'sub_title' => settingHelper('refund_protection_sub_title',$lang),
        ...
        if ($this->addon_identifier == 'reward')
        {
            $addons['data'] = [
                'conversion_rate' => settingHelper('reward_convert_rate'),
            ];
        }
        ...
        if ($this->addon_identifier == 'video_shopping')
        {
            $addons['data'] = [
        ...
        if ($this->addon_identifier == 'wholesale')
        {
            $addons['data'] = [
