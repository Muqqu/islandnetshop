...
class OrderController extends Controller
{
    ...
    public function payment(Request $request,CurrencyInterface $currency, OfflineMethodInterface $offlineMethod,AddonInterface $addon,LanguageInterface $language)
    {
        try {
            $user = null;
            if ($request->token) {
