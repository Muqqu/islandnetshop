          ...
          <div class="product-info">
            ...
            <div class="icons">
              <ul class="global-list">
                ...
                <li v-if="authUser && (checkWishlist(product) || product.user_wishlist)"><a href="javaScript:void(0)"
                                                                                            @click="removeWishlist(product.id)"><span
                    class="mdi mdi-name mdi-heart"></span></a></li>
                <li v-else-if="authUser"><a href="javaScript:void(0)" :class="{ 'disable_btn' :  is_disabled == true }"
