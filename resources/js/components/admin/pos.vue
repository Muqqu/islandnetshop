...
<!--                    class="bx bx-printer"></i></a>-->
            ...
            <div class="col-lg-12" v-if="order && order.is_draft == 0">
              <div class="cart-details">
                  <div class="card">
                      <div class="sg-card-header d-flex justify-content-between">
                        <table class="table table-striped table-md">
                          ...
                          <tr  class="table-data-row">
                            <td>1</td>
                            <td>{{this.order.order_date}}</td>
                            <td>{{ this.order.customer_name }}</td>
    ...
    <draft :draft="draft" :loading_image="loading_image" @invoiceDownload="invoiceDownload" :lang="lang" :loading_for_draft=loading_for_draft
           :cartProducts="cartProducts" :invoice_download_loading="invoice_download_loading" :recent_orders_length="recent_orders" @draftOrder="getDraftOrder"/>
