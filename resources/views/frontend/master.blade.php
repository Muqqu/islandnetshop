...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('frontend/css/materialdesignicons.min.css') }}?version=140">
    <link rel="stylesheet" href="{{ static_asset('frontend/css/vue-toastr-2.min.css') }}?version=140">


    <link rel="stylesheet" href="{{ static_asset('frontend/css/vue-slick-carousel.css') }}?version=140">
    <link rel="stylesheet" href="{{ static_asset('frontend/css/vue-slick-carousel-theme.css') }}?version=140">

    @if(isDemoServer())
        <link rel="stylesheet" href="{{ static_asset('frontend/css/color-switcher.css') }}?version=140">
    @endif

    @if($settings['text_direction'] == 'rtl')
        <link rel="stylesheet" href="{{ static_asset('frontend/css/rtl.css') }}?version=140">
    @endif
    <style>
        :root {
...
<script src="{{ static_asset('frontend/js/vue-toastr-2.js') }}?version=140"></script>
