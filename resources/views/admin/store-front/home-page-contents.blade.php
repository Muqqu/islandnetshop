                                                    ...
                                                    <div class="row mt-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-file">
                                                                    ...
                                                                    <select class="form-control selectric action_type"
                                                                        ...
                                                                        <option value="product" {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'product' ? 'selected' : '' }}>{{__('Product')}}</option>
                                                                        <option value="category" {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'category' ? 'selected' : '' }}>{{__('Category')}}</option>
                                                                        <option value="brand" {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'brand' ? 'selected' : '' }}>{{__('Brand')}}</option>
                                                                        @if(settingHelper('seller_system') == 1)
                                                                            <option value="seller" {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'seller' ? 'selected' : '' }}>{{__('Seller')}}</option>
                                                                        @endif
                                                                        <option value="blog" {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'blog' ? 'selected' : '' }}>{{__('Blog')}}</option>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="productDiv" id="product_{{ $content_count }}"
                                                                 style="{{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'product' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="product-by-ajax product-by-ajax form-control select2"
                                                                            ...
                                                                            aria-hidden="true">
                                                                        @if(array_key_exists($key,$banner_contetns['action_to'][$key]))
                                                                            @php
                                                            ...
                                                            <div class="categoryDiv" id="category_{{ $content_count }}"
                                                                 style="
                                                            {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'category' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                            ...
                                                            {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'blog' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                            ...
                                                            <div class="brandDiv" id="brand_{{ $content_count }}" style="{{
                                                                        array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'brand' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select class="form-control select2"
                                                                        ...
                                                                        @foreach($brands as $brand)
                                                                            <option
                                                                                    value="{{ $brand->id }}" {{ array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'brand' && $brand->id == $banner_contetns['action_to'][$key][$key] ? 'selected' : '' }}>{{ $brand->getTranslation('title', App::getLocale()) }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            @if(settingHelper('seller_system') == 1)
                                                                <div class="sellerDiv" id="seller_{{ $content_count }}"
                                                                     style="{{
                                                                            array_key_exists($key,$banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'seller' ? '' : 'display:none' }}">
                                                                    <div class="form-group">
                                                                        <label>{{ __('Action To') }}</label>
